...
@pytest.mark.parametrize(
    ...
    (
        ...
        ({
            'www-authenticate':
                'Digest realm="multi-d", nonce="8b11d0f6", opaque="cc069c" Basic realm="multi-b" '
        }, {
            'digest': {
                'realm': 'multi-d',
                'nonce': '8b11d0f6',
...
def test_digest_object():
  ...
  response = {
      'www-authenticate':
          'Digest realm="myrealm", nonce="KBAA=35", algorithm=MD5, qop="auth"'
  }
  content = b''
  ...
  working_request = (
      'authorization: Digest username="joe", realm="myrealm", nonce="KBAA=35",'
      ' uri="/test/digest/"' +
      ', algorithm=MD5, response="de6d4a123b80801d0e94550411b6283f", qop=auth,'
...
def test_digest_object_with_opaque():
  ...
  response = {
      'www-authenticate':
          'Digest realm="myrealm", nonce="30352fd", algorithm=MD5, qop="auth",'
          ' opaque="atestopaque"',
  }
  content = ''
  ...
  our_request = 'authorization: ' + headers['authorization']
  working_request = (
      'authorization: Digest username="joe", realm="myrealm", nonce="30352fd",'
      ' uri="/digest/opaque/", algorithm=MD5' +
...
def test_digest_object_stale():
  ...
  response['www-authenticate'] = ('Digest realm="myrealm", nonce="bd669f", '
...
def test_digest_object_auth_info():
  ...
  headers = {}
  response = httplib2.Response({})
  response['www-authenticate'] = ('Digest realm="myrealm", nonce="barney", '
                                  'algorithm=MD5, qop="auth", stale=true')
