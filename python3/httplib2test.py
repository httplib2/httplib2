...
class HttpTest(unittest.TestCase):
  ...
  def testGetViaHttps(self):
    ...
    (response, content) = self.http.request('https://google.com/adsense/',
                                            'GET')
    self.assertEqual(200, response.status)
  ...
  def testSslCertValidation(self):
    ...
    self.assertRaises(ssl.SSLError, http.request, 'https://www.google.com/',
                      'GET')
...
#        self.assertEqual(response.fromcache, True)
  ...
  def testPickleHttpWithConnection(self):
    ...
    self.assertEqual(
        list(self.http.connections.keys()), ['http:bitworking.org'])
