...
class CredentialsTest(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertTrue(('fred',
                         'password2') in list(c.iter('wellformedweb.org')))
        c.clear()
...
class HttpTest(unittest.TestCase):
    ...
    def testGetIRI(self):
        if sys.version_info >= (2, 3):
            uri = urllib.parse.urljoin(
                base,
                'reflector/reflector.cgi?d=\N{CYRILLIC CAPITAL LETTER DJE}')
    ...
    def testSslCertValidation(self):
        ...
        self.assertRaises(IOError, http.request, 'https://www.google.com/',
                          'GET')
...
#        self.assertEqual(response.fromcache, True)
    ...
    def testDigestAuthNextNonceAndNC(self):
        ...
        (response, content) = self.http.request(
            uri, 'GET', headers={'cache-control': 'no-cache'})
        info2 = httplib2._parse_www_authenticate(response,
                                                 'authentication-info')
        self.assertEqual(response.status, 200)
    ...
    def testDigestAuthStale(self):
        ...
        info3 = httplib2._parse_www_authenticate(response,
                                                 'authentication-info')
        self.assertEqual(response.status, 200)
...
class HttpPrivateTest(unittest.TestCase):
    ...
    def testConvertByteStr(self):
        ...
        self.assertEqual('Hello World',
                         httplib2._convert_byte_str(b'Hello World'))
    ...
    def testWsseAlgorithm(self):
        digest = httplib2._wsse_username_token(
            'd36e316282959a9ed4c89851497a717f', '2003-12-15T14:43:07Z',
            'taadtaadpstcsm')
